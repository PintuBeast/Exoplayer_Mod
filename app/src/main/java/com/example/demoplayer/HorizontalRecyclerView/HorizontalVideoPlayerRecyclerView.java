...
public class HorizontalVideoPlayerRecyclerView extends RecyclerView {
    ...
    private ImageView thumbnail, volumeControl, shareBtn, likeBtn, commentBtn, likeAnimate, download;
    ...
    private int screenDefaultWidth = 0;
    ...
    public HorizontalVideoPlayerRecyclerView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public HorizontalVideoPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (!isEndOfList) {
            ...
            targetPosition = 0;  //mediaObjects.size()-1 ;
        }
        ...
        HorizontalVideoPlayerViewHolder holder = (HorizontalVideoPlayerViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
       ...
       viewHolderParent = holder.itemView;
        ...
        if (mediaUrld != null) {
            playVideoFromUrl(mediaUrld, dataSourceFactory);
        }
        /////////////////////////////////////////////////////////////////
    }

    private void playVideoFromUrl(String videoUrl, DataSource.Factory dataSourceFactory) {
